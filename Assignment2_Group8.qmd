...
If we investigate the relationship based on the interest by city data, the correlation test result suggests that search frequencies for "crime" and "loans" might have a statistically negative relationship. However, lots of data are missing in this dataset which might affect the reliability of the correlation test result. 
...
If we investigate the relationship based on the interest by city data, the correlation test result suggests no statistically significant relationship between search frequencies for covid and mask at 0.05 significance level.
...
If we investigate the relationship based on the interest by city data, the correlation test result suggests a positive statistically significant relationship between search frequencies for covid and vaccine at 0.05 significance level. 
